...
const HabitCard: React.FC<HabitCardProps> = ({ id, name, bgColor, onClick }) => {
  return (
    <Card key={id} style={{ minWidth: '350px', minHeight: '63px', cursor: 'pointer'}} className={`dw-[30%] mx-auto flex flex-col justify-center my-2 relative ${bgColor}`} onClick={onClick}>
