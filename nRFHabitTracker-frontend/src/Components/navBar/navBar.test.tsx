...
describe('NavBar Component', () => {
  ...
  it('renders NavBar with all elements when user is logged in', () => {
    render(<Router><NavBar /></Router>); // Render NavBar within a Router for proper link handling.
  ...
  it('navigates to the device page when the Device link is clicked', () => {
    render(<Router><NavBar /></Router>); // Render the component again for isolation.
  ...
  it('navigates to the habits page when the Habits link is clicked', () => {
    render(<Router><NavBar /></Router>); // Repeat rendering for this test.
